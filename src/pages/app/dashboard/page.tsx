...
export default function Dashboard() {
  ...
  const summary = useQuery(
    api.reports.getWorkspaceSummary,
    workspaceId ? { workspaceId, daysBack: 7 } : "skip",
  );
        ...
        {loading ? (
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <StatCard
              ...
              value={openIncidents === 0 ? "All clear" : openIncidents}
              icon={AlertTriangle}
              color={openIncidents > 0 ? "text-destructive" : "text-chart-3"}
            />
            <StatCard
